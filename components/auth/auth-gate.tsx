...
export function AuthGate({ children }: Props) {
  ...
  useEffect(() => {
    ...
    getDoc(doc(clientDb, "inviteCodes", value))
      .then((snapshot) => {
  ...
  async function register(event: React.FormEvent) {
    ...
    try {
      ...
      await runTransaction(clientDb, async (transaction) => {
        const inviteRef = doc(
          collection(clientDb, "inviteCodes"),
          code!
        );
        ...
        console.log("exists:", invite.exists());
        console.log("data:", data);
        console.log("valid:", data?.valid);
        console.log("usedAt:", data?.usedAt);
        ...
        transaction.set(
          doc(clientDb, "users", credential.user.uid),
          {
            name: form.name,
            email: form.email,
  ...
  async function googleLogin() {
    ...
    try {
      ...
      await setDoc(
        doc(clientDb, "users", result.user.uid),
        {
    ...
    <main className="auth-shell">
      ...
      <section className="auth-card">
        <div className="auth-logo-wrap">
          <img className="auth-logo" src="/icon.svg" alt="JF Radar" />
        </div>
        ...
        <button className="auth-google" onClick={googleLogin} disabled={busy}>
